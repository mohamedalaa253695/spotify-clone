...
<div class="searchContainer">
	...
	<input type="text" class="searchInput" value="<?php echo $term;?>" name="" placeholder="Start Typing ..." onfocus="this.selectionStart = this.selectionEnd = this.value.length;">
...
<div class="gridViewContainer">
	...
	<?php
		...
		if(mysqli_num_rows($albumQuery) == 0 ){
			echo "<span class='noResults'>No akbums found matching" .$term."</span>";
		}
